    ...
    <div class="container">
        ...
        <div class="row mt-2">
            ...
            <div class="form-group col-md-3 mb-2">
                <label for="inputPassword4">R$ Investimento</label>
        ...
        <div class="row mt-2">
            ...
            <div class="form-group col-md-3 mb-2">
                ...
                <input type="text" id="cub" name="cub" class="form-control {{ $errors->has('cub') ? 'is-invalid' : '' }}" value="{{ old('cub', $work->cub) }}" placeholder="Será retirado">
            </div>

            <div class="form-group col-md-3 mb-2">
                <label for="inputPassword4">Tipo de Cotação</label>
                <input type="text" id="quotation_type" name="quotation_type" class="form-control {{ $errors->has('quotation_type') ? 'is-invalid' : '' }}" value="{{ old('quotation_type', $work->quotation_type) }}" placeholder="Será retirado">
            </div>

            <div class="form-group col-md-3 mb-2">
                <label for="inputPassword4">R$</label>
                <input type="text" id="coin" name="coin" class="form-control {{ $errors->has('coin') ? 'is-invalid' : '' }}" value="{{ old('coin', $work->coin) }}" placeholder="Será retirado">
            </div>
        </div>
