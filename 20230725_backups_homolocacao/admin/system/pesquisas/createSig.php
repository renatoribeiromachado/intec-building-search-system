...
?>
<div class="container">
    <h4><b>Cadastro de SIG - Obra</b></h4>
    <?php
        $Projeto = filter_input(INPUT_GET, 'Projeto', FILTER_DEFAULT);
        $Codigo  = filter_input(INPUT_GET, 'Codigo', FILTER_DEFAULT);
        $CodigoEmp  = filter_input(INPUT_GET, 'CodigoEmp', FILTER_DEFAULT);
        $CodigoAntigo  = filter_input(INPUT_GET, 'CodigoAntigo', FILTER_DEFAULT);
        ...
        if (!empty($data) && isset($data['SendPostForm'])):
            ...
            require('_models/AdminSigObra.class.php');
            $cadastra = new AdminSigObra;
    ...
    <form class="search" autocomplete="off" name="PostForm" action="" method="post">
        ...
        <input type="hidden" name="IDEMPRESA_OBRA" id="id" value="<?= $CodigoEmp;?>" />
        <input type="hidden" name="Codigo" id="id" value="<?= $Codigo;?>" />
        ...
        <div class="col-lg-12">
            <p><b>OBRA:</b> <?= $CodigoAntigo;?> - <?= $Projeto;?></p>
    ...
    <div class="col-md-12">
        <p class="boxtitle"><i class="glyphicon glyphicon-check"></i> <b>SIG RELATADO PARA ESSA OBRA: <?= $Projeto;?></b></p>
            ...
            <?php
                ...
                $readF->FullRead("SELECT fup.IDFOLLOWUP, fup.DATA,
                                    ...
                                    FROM tb_followup_fup AS fup
                                        LEFT JOIN tb_usuario_usu AS usu
                ...
                if(!$readF->getResult()):
                    WSErro("Nenhum SIG relatado para essa obra até o momento!", WS_INFOR);
                    else:
