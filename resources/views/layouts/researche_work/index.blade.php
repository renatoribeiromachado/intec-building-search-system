                ...
                <form action="" id="formulario" method="POST">  
                    ...
                    <div class="row mt-2 bg-light border">
                        <div class="col-md-12 pt-3">
                            <p class="text-uppercase"><i class="fa fa-search"></i> <strong>Busca por Período</strong> <code>* entre Datas</code></p>
                            <hr>
                        </div>

                        <div class="col-md-6 pb-5">
                            <label class="control-label"><strong>Data Inicial</strong></label>
                            <input type="text" name="started_at" class="form-control datepicker" value="" placeholder="Data Inicial..."/>
                        </div>
                        <div class="col-md-6 pb-5">
                            <label class="control-label"><strong>Data Final</strong></label>
                            <input type="text" name="ends_at" class="form-control datepicker" value="" placeholder="Data Final..."/>
                        </div>
                    </div>
                    ...
                    <div class="row mt-4 pb-4">
                        ...
                        <div class="col-md-3">
                            ...
                            <br>
                            <button type="submit" class="btn btn-primary create" title="Salvar Pesquisa" value="1" onclick="Acao('');"><i class="fa fa-search"></i> Salvar Pesquisa</button>
                            <button type="submit" class="btn btn-success submit" title="Pesquisar" onclick="Acao('');"><i class="fa fa-search"></i> Pesquisar</button>
                        </div>
                    </div>
                </form>
            </div>
