                    ...
                    <tbody>
                        @forelse($reports as $report)
                            <tr>
                                ...
                                <td class="text-primary">{{ $report->company->trading_name }}</td>
                                ...
                                <td>
                                     <form action="{{ route('sig-company.destroy', $report->id) }}" method="POST" onsubmit="return confirm('Tem certeza que deseja deletar?')">
                                        @csrf
                                        @method('DELETE')
        ...
        <div class="modal-dialog modal-xl" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form action="{{ route('sig-company.update') }}" method="POST">
