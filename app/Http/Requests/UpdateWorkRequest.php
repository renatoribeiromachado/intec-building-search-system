...
class UpdateWorkRequest extends FormRequest
{
    ...
    {
        return [
            'old_code' => "required|min:3|max:20|unique:works,old_code,{$this->work->id},id",
            //'last_review' => ['nullable', 'date_format:d/m/Y'],
            'researcher_id' => 'required',
            'revision' => 'required',
            'name' => "required|unique:works,name,{$this->work->id},id",
    ...
    public function messages()
    {
        return [
            ...
            'price.max' => 'O campo Preço não deve ser maior que 13 dígitos.',
        ];
    }
}
